...
public class BookControllerTest {
    ...
    @Test
    @DisplayName("Deve deletar o livro existente")
    ...
    @Test
    @DisplayName("Quando o livro não for encontrado, deve lançar NOT FOUND")
    ...
    public void updateBookFailedTest() throws Exception {
